# Geography and the Environment Pupil’s Book Standard 3 — ADT Bundle Reference
...
**Geography and the Environment Pupil’s Book Standard 3** — This is a Tanzanian primary school geography textbook in English for Standard 3 pupils, roughly aimed at lower primary learners. It introduces basic ideas about geography and the environment, covering surroundings at home and school, major relief features of Tanzania, environmental conservation, environmental degradation, and climate change. The book has a practical, competency-based approach, using activities, questions, pictures and exercises to help children connect everyday life with sustainable use of natural resources and care for the environment.
...
├── GEOGRAPHY-STD-3---BLEED-.db                    # SQLite database (pipeline state)
├── GEOGRAPHY-STD-3---BLEED-.pdf                   # Original source PDF
...
| `pg{NNN}_im{NNN}` | Image alt text / description | `pg001_im006` |
...
{
  "pg001_gp001_tx001": "",
  "pg001_im006": "Book cover title reading “Geography and the Environment, Pupil’s Book, Standard 3”.",
  "gl001": "abrasive",
  "gl001_def": "a material used to rub, smooth, clean, or polish a hard surface",
  "qz001_que": "Which of these is a natural thing in the environment?",
  "qz001_o0": "1) road",
  "qz001_o0_exp": "❌ Not quite. A road is man-made because people build it."
}
```
...
```json
{
  "abrasive": {
    "word": "abrasive",
    "definition": "a material used to rub, smooth, clean, or polish a hard surface",
    "variations": ["abrasive","abrasives"],
    "emoji": "🪨✨"
  }
}
```
...
```json
{
  "title": "Geography and the Environment Pupil’s Book Standard 3",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en-GB"
...
<body>
    <div id="content" class="opacity-0">
        <section role="article" data-section-type="text_and_single_image"
            ...
            <img data-id="pg001_im006" src="images/pg001_im006.png" ...>
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    ...
    <p data-id="qz001_que">Which of these is a natural thing in the environment?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="❌ Not quite. A road is man-made because people build it." data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) road</span>
    </label>
    <!-- more options... -->
</section>
...
| Original PDF | `GEOGRAPHY-STD-3---BLEED-.pdf` |
| Pipeline database | `GEOGRAPHY-STD-3---BLEED-.db` (SQLite) |
